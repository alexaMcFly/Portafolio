...
<?php 
	...
	if (isset($_GET['noFactura'])) {
		...
		$query = "SELECT * FROM egresos WHERE noFactura = '$noFactura_ed'";
	...
	if(isset($_POST['update'])){
		...
		$query = "UPDATE egresos SET noFactura = '$noFact', fecha = '$fecha', rfc = '$rfc', importe = '$importe', iva = '$iva', total = '$total' WHERE noFactura = '$noFactura_ed'";
	...
	<div class="row">
		<div class="col md-4 mx-auto">
			<div class="card card-body">
				<form action="editEgreso.php?noFactura=<?php echo $_GET['noFactura']; ?>" method="POST">
